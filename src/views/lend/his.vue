...
<template>
    <div>
        ...
        <div class="data-control">
            ...
            <Button type="primary" @click="$downloadByForm('/export/lend/his',filter)">导出</Button>
        </div>
...
import { getLendhisList } from "@/actions/lend";
export default {
  name: "lend_his",
  data() {
    return {
  ...
  methods: {
    loadData() {
      this.loading = true;
      getLendhisList(this.filter).then(res => {
        this.loading = false;
